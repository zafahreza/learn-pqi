    ...
    return (
        <div className='min-w-[395px] border-[1px] rounded-[15px] border-black border-opacity-50 p-6 flex flex-col gap-[25px]'>
            <div className='flex justify-between'>
                ...
                <div key={index} className="flex items-center justify-between pt-5 pb-5 pl-5 pr-5 border-[1px] border-black border-opacity-40 rounded-[10px] gap-2">
                ...
                <button type='button' id='SendButton' className='w-full h-11 bg-[#00438F] rounded-[10px] text-[white] font-[500] text-[16px]' onClick={handleSubmit}>Kirim</button>
