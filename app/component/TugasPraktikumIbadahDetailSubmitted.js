...
import InputFileIbadahSubmitted from "./InputFileIbadahSubmitted";

export default function TugasPraktikumIbadahDetailSubmitted(){
    return(
        <div className="flex flex-col items-center pt-[60px]">
            <div className="w-[850px] h-[140px] flex flex-col justify-center pl-[58px] bg-[#0078CE] rounded-[20px] mt-[40px] mb-[28px]">
                <Link href="/Dashboard/PraktikumIbadah/TugasSection" className="font-Poppins font-[600] text-[20px] text-white">Praktikum Ibadah</Link>
                <p className="font-[600] text-[32px] text-white">Tugas 3 - Presentasi</p>
                <p className="font-[500] text-[14px] text-white">6 Maret 2023</p>
            </div>
            <div>
                <p className="font-[400] text-[14px] text-black mb-10">Buatlah makalah beserta power point sesuai  dengan materi dan anggota kelompok yang telah ditentukan.<br/>Harap dikumpulkan sebelum deadline yang telah ditentukan.</p>
            </div>
            <InputFileIbadahSubmitted />
