...
export default function MateriPraktikumQiroahDetail(){
    return(
        <div className="flex flex-col items-center pt-[60px] pb-10">
            <div className="w-[850px] h-[140px] flex flex-col justify-center pl-[58px] bg-[#0078CE] rounded-[20px] mt-[40px] mb-[28px]">
                <Link href="/Dashboard/PraktikumQiroah/MateriSection" className="font-Poppins font-[600] text-[20px] text-white">Praktikum Qiroah</Link>
