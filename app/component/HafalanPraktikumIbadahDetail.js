...
import InputFileHafalan from "./InputFileHafalan";

export default function HafalanPraktikumIbadahDetail(){
    return(
        <div className="flex flex-col items-center pt-[60px]">
            <div className="w-[850px] h-[140px] flex flex-col justify-center pl-[58px] bg-[#0078CE] rounded-[20px] mt-[40px] mb-[28px]">
                ...
                <p className="font-[600] text-[32px] text-white">Doa sebelum belajar</p>
                <p className="font-[500] text-[14px] text-white">Tenggat waktu : 25 Juni 2023 (23.59)</p>
            </div>
            <div>
                <p className="font-[400] text-[14px] text-black mb-10">Buatlah video hafalan Doa sebelum belajar. Harap dikumpulkan sebelum deadline yang telah ditentukan.</p>
            </div>
            <InputFileHafalan />
