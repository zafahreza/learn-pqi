...
import HafalanPraktikumIbadahDetail from "@/app/component/HafalanPraktikumIbadahDetail";

const PraktikumIbadahHafalan = ({ params }) => {
  ...
  return (
    <RootLayout title={pageTitle}>
        <main className="w-screen h-screen bg-[#FFF]">
            ...
            <HafalanPraktikumIbadahDetail params={params}/>
        </main>
    </RootLayout>
  )
}

export default PraktikumIbadahHafalan