...
import MateriPraktikumIbadah from "@/app/component/MateriPraktikumIbadah";
import { useEffect } from "react";


const PraktikumIbadah = ({ params }) => {
  ...
  const pageTitle = "LearnPQI - Praktikum Ibadah";
  return (
    <RootLayout title={pageTitle}>
        <main className="max-w-screen min-h-screen pb-10 bg-[#C1E3FB]">
            ...
            <MateriPraktikumIbadah params={params}/>
        </main>
    </RootLayout>
  )
}

export default PraktikumIbadah