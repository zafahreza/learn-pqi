...
import TugasPraktikumIbadahDetail from "@/app/component/TugasPraktikumIbadahDetail";
import { useEffect } from "react";


const PraktikumIbadahTugas = ({ params }) => {
  ...
  return (
    <RootLayout title={pageTitle}>
        <main className="w-screen h-screen bg-[#FFF]">
            ...
            <TugasPraktikumIbadahDetail params={params}/>
        </main>
    </RootLayout>
  )
}

export default PraktikumIbadahTugas