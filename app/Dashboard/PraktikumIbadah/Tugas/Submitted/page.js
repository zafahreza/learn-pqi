...
import TugasPraktikumIbadahDetailSubmitted from "@/app/component/TugasPraktikumIbadahDetailSubmitted";

const PraktikumIbadahTugasSubmitted = ({ params }) => {
  ...
  const pageTitle = "LearnPQI - Tugas Praktikum Ibadah";
  return (
    <RootLayout title={pageTitle}>
        <main className="max-w-screen min-h-screen bg-[#FFF]">
            ...
            <TugasPraktikumIbadahDetailSubmitted params={params}/>
        </main>
    </RootLayout>
  )
}

export default PraktikumIbadahTugasSubmitted