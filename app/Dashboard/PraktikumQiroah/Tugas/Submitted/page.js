...
import TugasPraktikumQiroahDetailSubmitted from "@/app/component/TugasPraktikumQiroahDetailSubmitted";

const PraktikumQiroahTugasSubmitted = ({ params }) => {
  ...
  const pageTitle = "LearnPQI - Tugas Praktikum Qiroah";
  return (
    <RootLayout title={pageTitle}>
        <main className="w-screen h-screen bg-[#FFF]">
            ...
            <TugasPraktikumQiroahDetailSubmitted params={params}/>
        </main>
    </RootLayout>
  )
}

export default PraktikumQiroahTugasSubmitted