...
import HafalanPraktikumQiroahDetailSubmitted from "@/app/component/HafalanPraktikumQiroahDetailSubmitted";

const PraktikumQiroahHafalanSubmitted = ({ params }) => {
  ...
  return (
    <RootLayout title={pageTitle}>
        <main className="w-screen h-screen bg-[#FFF]">
            ...
            <HafalanPraktikumQiroahDetailSubmitted params={params}/>
        </main>
    </RootLayout>
  )
}

export default PraktikumQiroahHafalanSubmitted